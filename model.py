...
def denseblock(x, concat_axis, nb_layers, growth_rate,
    ...
    for i in range(nb_layers):
        ...
        list_feat.append(x)
        x = tf.concat(list_feat, concat_axis)
...
def get_model_deep_speckle():
    ...
    db1 = denseblock(x=conv1, concat_axis=3, nb_layers=4,
    ...
    db2 = denseblock(x=conv2, concat_axis=3, nb_layers=4,
                     growth_rate=16, dropout_rate=0.5)
    ...
    db3 = denseblock(x=conv3, concat_axis=3, nb_layers=4,
                     growth_rate=16, dropout_rate=0.5)
    ...
    db4 = denseblock(x=conv4, concat_axis=3, nb_layers=4,
                     growth_rate=16, dropout_rate=0.5)
    ...
    db5 = denseblock(x=conv5, concat_axis=3, nb_layers=4,
                     growth_rate=16, dropout_rate=0.5)
    ...
    db6 = denseblock(x=conv6, concat_axis=3, nb_layers=3,
                     growth_rate=16, dropout_rate=0.5)
    ...
    db7 = denseblock(x=conv7, concat_axis=3, nb_layers=3,
                     growth_rate=16, dropout_rate=0.5)
    ...
    db8 = denseblock(x=conv8, concat_axis=3, nb_layers=3,
                     growth_rate=16, dropout_rate=0.5)
    ...
    db9 = denseblock(x=conv9, concat_axis=3, nb_layers=3,
                     growth_rate=16, dropout_rate=0.5)
